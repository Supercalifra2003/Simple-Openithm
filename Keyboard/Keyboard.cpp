...
size_t Keyboard_::press(uint8_t k) {
  ...
  if (_keyReport.keys[0] != k && _keyReport.keys[1] != k &&
      ...
      _keyReport.keys[12] != k && _keyReport.keys[12] != k &&
...
void Keyboard_::releaseAll(void) {
  ...
  _keyReport.keys[8] = 0;
  _keyReport.keys[9] = 0;
  _keyReport.keys[10] = 0;
  _keyReport.keys[11] = 0;
  _keyReport.keys[12] = 0;
  _keyReport.keys[13] = 0;
  _keyReport.keys[14] = 0;
  _keyReport.keys[15] = 0;
  _keyReport.keys[16] = 0;
  _keyReport.keys[17] = 0;
  _keyReport.keys[18] = 0;
  _keyReport.keys[19] = 0;
  _keyReport.keys[20] = 0;
  _keyReport.keys[21] = 0;
